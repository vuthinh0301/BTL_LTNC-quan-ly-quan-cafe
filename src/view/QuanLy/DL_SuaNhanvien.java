...
nhanvienDAO dao = new nhanvienDAO();
    public DL_SuaNhanvien(java.awt.Frame parent, boolean modal,int ma) {
        super(parent,modal);
        initComponents();
           this.id = ma;
           nhanvien nv = dao.getID(id);
       ...
       txtcard.setText(String.valueOf(nv.getCard()));
      jDateChooser1.setDate(java.sql.Date.valueOf(nv.getDate()));    
