 ...
 * @author Admin
 */
public class DL_Sua extends javax.swing.JDialog {
     ...
     */
    int id;
    datbanDAO db = new datbanDAO();
    int ma_ban;
    public DL_Sua(java.awt.Frame parent, boolean modal, int ma) {
        super(parent, modal);
        initComponents();
        this.id = ma;
       
        khachhang kh = db.getId(id);
         this.ma_ban = kh.getTable_id();
        txtTen.setText(kh.getName());
        fill();
        txtphone.setText(kh.getPhone());
        txtemail.setText(kh.getEmail());
        jDateChooser1.setDate(java.sql.Date.valueOf(kh.getDate()));
        txtsl.setSelectedIndex(kh.getQuantity());
        jcbGio.setSelectedIndex(Integer.parseInt(kh.getGio()));
       
        if (Integer.parseInt(kh.getPhut()) < 10) {
            jcbPhut.setSelectedIndex(Integer.parseInt(kh.getPhut()));

        } else {
            jcbPhut.setSelectedItem(kh.getPhut());
        }
    }
    ...
    private void fill() {
        ...
        banDAO bandao = new banDAO();
         khachhang kh = db.getId(id);
        lsban = bandao.readstatusbyID(kh.getTable_id());
        ...
        for (int i = 0; i < lsban.size(); i++) {
            ...
            if (b.getId() == kh.getTable_id()) {
                jComboBox1.setSelectedIndex(i);
                 jLabel1.setText("Sửa thông tin - "+b.getName());
            }
        }
        ...
        jcbPhut.setModel(cbphut);
         DefaultComboBoxModel cbsl = new DefaultComboBoxModel();
        for (int i = 0; i < 11; i++) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (row > 0) {
            ...
            System.out.println("ko sua duoc");
        }
